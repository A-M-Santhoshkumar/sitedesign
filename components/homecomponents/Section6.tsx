...
function Section6() {
  ...
  const inputClass = (field: keyof FormDataType) =>
    `border p-3 rounded-md w-full text-black dark:text-white bg-white dark:bg-transparent
     placeholder-gray-500 dark:placeholder-gray-400
     focus:outline-none focus:ring-2 transition
     ${
       errors[field]
         ? "border-red-500 focus:ring-red-400"
         : "border-gray-300 dark:border-white focus:ring-pink-400 dark:focus:ring-yellow-400"
     }`;
